...
while true; do
  ...
  LIMIT_HUNTER_ALLOWED_DECISIONS=CRYPTO_BUY_FAIR_EDGE,CRYPTO_WAIT_ENTRY_ASK_TOO_HIGH,CRYPTO_AVOID_ASK_TOO_HIGH \
  LIMIT_HUNTER_MIN_EDGE=0.20 \
  LIMIT_HUNTER_MIN_SCORE=40 \
  ...
  LIMIT_HUNTER_MAX_OPEN=2 \
  LIMIT_HUNTER_MAX_PENDING=5 \
  LIMIT_HUNTER_MAX_NEW_ORDERS_PER_CYCLE=2 \
